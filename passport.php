    ...
    <div class="main">
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="traffic.php" target="_blank"><img src="image/traffic-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
...
<div class="right-index-main">
        ...
        <div class="boxes-main we-are-near-m">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
              <td><p class="mission_heading">SPECIAL BRANCH – Verification related to Passport and character &amp; antecedents. </p><br>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody><tr>
                    <td><h2>Passport  Verification</h2>
                      <p>The Special Branch of Delhi Police is  functioning at Police Bhawan, Asaf Ali Road, New Delhi<strong> </strong>and deals with the verification of passport applications  received <strong>on-line</strong> (<u>www.passportindia.gov.in</u>)  through Passport Seva Kendras &nbsp;&nbsp;located at (1) Aggarwal Tower, Plot No. 2,  District Centre, Shalimar Place, Outer Ring Road (North-West), ( 2) &nbsp;Herald House, Bahadur Shah Zafar Marg, New  Delhi and &nbsp;(3) Hudco Trikoot-III, Bhikaji  Cama Place, R.K. Puram, New Delhi. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                      <p>The detailed procedures, instructions and documents  required for submitting of application (on-line) for Indian Passport, can be  seen at the website (<a href="http://www.passportindia.gov.in/">www.passportindia.gov.in</a>)  of Ministry of External Affairs, GOI, New    Delhi.</p>
                      <p>The  following formalities are to be complied with by the passport applicant at the  time of police enquiry:-</p>
                        <ul>
                          <li><strong>Birth Proof: - </strong>Birth  Certificate (photocopy) issued by Municipal Authority or any office authorized  to issue Birth Certificate (who born on or after 26/01/1989).&nbsp; School Leaving certificate/secondary school  leaving certificate/certificate of recognized boards/institutions from the  school last attended by the applicant (who born before 26/1/89).&nbsp; Affadavit sworn before a Magistrate stating  date/place of birth by illiterate or semi-illiterate applicants (Less than 5th  class).</li>
                        </ul>
      </td>
      </tr>
      <tr><td><a href="passport1.php"><center><input type="button" value=">>next<<" /></center></a></td></tr>
      </tbody>
      </table>
     </td>
     </tr>
...
<div class="footer-main">
  <div class="footer">
    <table border="0" align="center" cellpadding="0" cellspacing="0">
      <tbody><tr>
        <td align="center" style="margin-top:10px;">Copyright©Mukesh Gorai 2017 All Right Reserved </td>
        <td align="right">&nbsp;</td>
