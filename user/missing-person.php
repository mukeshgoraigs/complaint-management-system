...
function showUser(str) {
  ...
  xmlhttp.open("GET","missing-action.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<option value="">Select a name for search </option>
<option value="11">sanju kumari</option>
<option value="12">mhadev pesad</option>
<option value="13">ramni devi</option>
<option value="14">sudrshan ji</option>
<option value="15">KRISHNA</option>
</select>
</form>
<br>
