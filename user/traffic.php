...
<div class="headers">
      <div class="header">
        <div class="logo1"><a href="#"><img src="image/logo3 .PNG" alt="" width="326" height="87" border="0"></a><a href="#"></a>
        </div>
        
        <div class="lef-top-icon-logo"><img src="image/logo5.png" width="254" height="76" alt=""></div>
      </div>
  </div>
</div>
    ...
    <div class="main">
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="traffic_unit.php" target="_blank"><img src="image/traffic-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
...
<div class="right-index-main">
  ...
  <div id="featured_slide" class="clear">
    ...
    <div id="featured_content">
      <div class="featured_box" id="fc1"><img src="image/traffic/trffic1.jpg" alt="" />
       
      </div>
      <div class="featured_box" id="fc2"><img src="image/traffic/trffic2.png" alt="" />
       
      </div>
      <div class="featured_box" id="fc3"><img src="image/traffic/trffic3.png" alt="" />
        
      </div>
      <div class="featured_box" id="fc4"><img src="image/traffic/trffic4.png" alt="" />
        
      </div>
      <div class="featured_box" id="fc5"><img src="image/traffic/trffic5.png" alt="" />
...
<div style="min-height:314px; background:url(image/traffic/traffic1.png)" class="text-cont">
     
  
  <!-- <img style="padding-left:10px; width:220px; height:176px; float:right;" src="images/cp.jpg"/> -->
  <img src="image/help-line-head1.png" width="120" height="32" alt="" style="margin-top:120px;">
        <div class="news-flash2">
        <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="4">
        
        <img src="image/healp-line-bullet.png" width="11" height="13" alt=""><a href="traffic-chalan.php" style="background:none; color:#000;">&nbsp;Online e-challan registration</a> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/healp-line-bullet.png" width="11" height="13" alt="">&nbsp;<a href="#" style="background:none; color:#000;">e-challan status</span>
        </marquee>
        </div> 
...
<div style="clear:both"></div>
   ...
   <table>
      <tr>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><img src="image/circle.jpg" class="tabul1" /></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><img src="image/community.jpg" class="tabul1" /></td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
         <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><img src="image/knowledge.jpg" class="tabul1" /></td>
      </tr>
   </table>
 <!------------------End mid Div---------------------------------->      
      </div>
