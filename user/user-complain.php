...
<!---Slider is end---->      
 ...
 <fieldset class="tabul1"> 
  ...
  <table align="center">
  <form id="f1" name="f1" method="POST" action="http://localhost/crimesolution/user/user-complain-action.php">
     <tr>
       <td><font color="#000000">F.I.R. id:</font></td>
     ...
     <tr>
        ...
        <td><textarea rows="3" cols="50" id="t2" name="t2" style="resize:none;"></textarea></td>
     </tr>
     <tr>
        <td><font color="#000000">Contact No.:</font></td>
        <td><input type="number" id="t3" name="t3"/></td>
     </tr>
     <tr>
        <td><font color="#000000">Complain:</font></td>
        <td><textarea rows="10" cols="50" id="t4" name="t4" style="resize:none;"></textarea></td>
     </tr>
     <tr>
