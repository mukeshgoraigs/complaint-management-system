...
<div class="right-index-main">
 ...
 <!---Slider is end---->      
        ...
        <div class="clr"></div>
  <!-------------------Mid Div Start------------------------------>     
<div style="min-height:314px; background:#FFC;" class="text-cont" >
     
  <!-- <img style="padding-left:10px; width:220px; height:176px; float:right;" src="images/cp.jpg"/> -->
 <fieldset class="tabul1"> 
  <legend style="font-weight:bolder; font-size:18px; color:#33F;">Challan</legend>
  <form id="f1"  name="f1" method="post" action="traffic-chalan-conn.php">
  <table align="center">
  <tr>
      <td>Name:</td>
    ...
    <tr>
      <td>Date</td>
      <td><input type="date" name="t6" id="t6" /></td>
    </tr>
  </table>
  <table align="center">
  <tr>
...
<div class="footer-main">
  <div class="footer">
    <table border="0" align="center" cellpadding="0" cellspacing="0">
      <tbody><tr>
        <td align="center">Copyright©Mukesh Gorai2017 All Right Reserved </td>
        <td align="right">&nbsp;</td>
