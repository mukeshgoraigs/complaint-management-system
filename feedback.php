...
<div style="min-height:314px; background:#FFC;" class="text-cont" >
 ...
 <fieldset class="tabul1"> 
  <legend style="font-weight:bolder; font-size:18px; color:#33F;">feedback</legend>
  <form id="f1"  name="f1" method="post" action="feedback-action.php">
  <table align="center">
  <tr>
    ...
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td><font color="#0000CC">Gender:</font></td>
      <td><input type="radio" name="gender" value="female" />female</td>
      <td><input type="radio" name="gender" value="male" />male</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td><font color="#0000CC">Address:</font></td>
       <td><input type="text" name="t2" id="t2" /></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
       <td><font color="#0000CC">Email</font></td>
       <td><input type="email" name="t3" id="t3" /></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td><font color="#0000CC">Message</font></td>
      <td><input type="text" name="t4" id="t4" ></td>
    </tr>
    <tr>
    <td><font color="#0000CC">Date</font></td>
