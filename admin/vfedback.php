    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td>
            <form id="f1" name="f1" method="post" action="vfedbackconn.php">
      <table cellpadding="4" cellspacing="10">
        <tr>
           <td>View  feedback</td><td><select name="s1" id="s1">
                        <option value="0">select</option>
                        <option value="1">feedback no.</option>
        ...
        <tr>
           <td colspan="2">
            <input type="submit" id="s11" name="s11"  value="view feedback">
           </td>
        </tr>
      </table>
    </form>
