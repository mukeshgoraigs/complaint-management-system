...
<ul id="flexmenu3" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1003; left: 534px; top: 152px; display: none;">
        ...
        <li><a href="wview-fir.php">Women FIR</a></li>
    ...
    <div class="main">
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="image/traffic-unit.jpg" target="_self"><img src="image/traffic-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
...
<div class="right-index-main">
        ...
        <div class="boxes-main we-are-near-m">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
              <td><p class="mission_heading">ABOUT FUNDS</p><br>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody><tr>
                    <td><p>Two  Societies of Ranchi Police i.e. <em>“Ranchi  Police Martyrs’ Fund” </em>and “<em>Ranchi  Police Yuva Foundation</em> “ have already been registered with the Registrar of  Societies Registration of Act., XXI of 1860 on 25.04.2013 &amp; 10.12.2012  respectively.</p>
                      <p>Above  mentioned two societies have been granted registration u/s 12A of Income Tax  Act. 1961 as well as u/s 80 G (5) (vi) of the Income Tax Act., 1961.</p>
                      <p>As  per section 12 A of Income Tax Act 1961, <strong>the  income of the society (out of investment / F.D. etc.) is exempted from income  tax</strong> on fulfillment of certain conditions.</p>
                      <p>Under  section 80 G (5) (vi) of Income Tax Act, 50 % amount of donation to the above  societies shall qualify for exemption from income tax. The amount of donation  exceeding 10% of gross income will not be considered for exemption.</p>
                      <p>In  order to claim the above exemption, a receipt will be given to each donor  separately bearing the number and date of the order issued by “Director of  Income Tax (Exemption)” as mentioned below :-</p>
                      <ol>
                        <li>Ranchi Police Martyrs’ Fund                      </li>
                      </ol>
                      <p>Order under section 80 G (5) (vi) of  the Income Tax Act, issued vide no. NQ.DIT (E)I 2013-14/DEL – DE24783 –  06062013 3384 dated 06/06/2013 and valid w.e.f. Assessment year 2014-15 onwards  till it is rescinded.</p>
                      <div style="background:#eee; padding:3px 0px;">
                        <h3 align="center"><strong>Current Account No. 18200110036907,<br>
                          Ranchi Police Martyrs  Fund,<br>
                          State BankOf India ,Lalpur branch,Ranchi.</strong></h3>
                      </div>
                      <p>2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ranchi  Police Yuva Foundation</p>
                      <p>Order under section 80G (5) (vi) of  the Income Tax Act, issued vide no. NQ.DIT (E)I 2013-14/DEL – DE24782 –  06062013 1846 dated 06/06/2013 and valid w.e.f. Assessment year 2014-15 onwards  till it is rescinded.</p>
                      <div style="background:#eee; padding:3px 0px;">
                        <h3 align="center"><strong>Current Account No. 32825160108,</strong><br>
                          <strong>Ranchi</strong><strong> Police  Yuva Foundation,</strong><br>
                          <strong>State Bank Of India ,Lalpur Branch,Ranchi.</strong></h3>
                      </div>
