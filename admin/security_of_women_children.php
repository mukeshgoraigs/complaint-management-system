...
<ul id="flexmenu3" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1003; left: 534px; top: 152px; display: none;">
        ...
        <li><a href="wview-fir.php">view women fir</a></li>
        <li><a href="view-comp.php">View Complain</a></li>
    ...
    <div class="main">
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
          ...
          <tr>
            <td><a href="traffic_unit.php"><img src="image/traffic-unit.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><a href="#"><img src="css/event-calendar.gif" width="242" height="60" alt=""></a></td>
          </tr>
          <tr>
            <td height="10">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><a href="#"><img src="css/2pic.png" width="242" height="90" alt=""></a></td>
          </tr>
        </tbody></table>
      </div>
...
<div class="right-index-main">
  ...
  <div id="featured_slide" class="clear">
    ...
    <div id="featured_content">
      <div class="featured_box" id="fc1"><img src="image/sld1.png" alt="" />
       
      </div>
      <div class="featured_box" id="fc2"><img src="image/sld2.png" alt="" />
       
      </div>
      <div class="featured_box" id="fc3"><img src="image/sld3.png" alt="" />
        
      </div>
      <div class="featured_box" id="fc4"><img src="image/sld4.jpg" alt="" />
        
      </div>
      <div class="featured_box" id="fc5"><img src="image/sld5.jpg" alt="" />
...
<div style="min-height:314px;" class="text-cont">
  ...
  <img width="220" height="176" src="image/SERVICES.jpg" class="attachment-post-thumbnail wp-post-image" alt="cp">  <div class="ips"> <center>Services Of <br>
Special Crime Solution Unit<br />
For Women & Children</center> </div>
  <p>The year 2013 has been witness to the meticulous implementation of a slew of measures pertaining to women’s safety. These include increasing the number of call-takers on the Telephone Nos. 100 and 1091; creation of 24×7 women helpdesks at all police stations; conversion of 522 posts of male Constables to that of Woman Constables and creation of additional posts of 306 W/SIs and 778 Woman Constables; interaction with students and teachers of girls colleges and schools; self defence training programmes; deployment of PCR vans, Motor Cycles and pickets to cover vulnerable locations and appointment of […]</p>
<a class="readmore" href="#">Read More.. </a><a href="security_of_women_children_complain.php"> 
<marquee behavior="alternate" direction="left" scrollamount="4" style="margin-top:25px; color:#F00; font-weight:bolder; font-size:18px;">Online Complain Register</marquee></a>
 </div>
