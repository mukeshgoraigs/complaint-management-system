...
<?php
	   $conn=@mysql_connect("localhost","root","");
		 ...
		 $n=$_REQUEST['t1'];
		    if($op==1)
			{
				$qry="select * from missing_person where serial_no='$n'";
			}
			else
			{
				$qry="select * from missing_person where miss_date='$n'";
			}
			$smt=mysql_query($qry);
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td>
       <form id="f1" name="f1" method="post" action="update-action1.php">
    <table>
          <tr>
             <th>Serial No.</th>
             <td>
                <input type="text" id="t1" name="t1" value="<?php echo                 $rs['serial_no']  ?> ">
             </td>
          </tr>
          <tr>  
             <th>Missing Date</th>
             <td>
                <input type="text" id="t2" name="t2" value="<?php echo                    $rs['miss_date']?>">
             </td>
          </tr>
          <tr>
             <th>Name</th>
             <td>
                <input type="text" id="t3" name="t3" value="<?php echo                   $rs['name'] ?>">
             </td>
          </tr>
          <tr>
             <th>Gender</th>
             <td>
                <input type="text" id="t4" name="t4" value="<?php                   echo $rs['gender'] ?>">
             </td>
          </tr>
          <tr>
             <th>Photo</th>
             <td>
             <?php  echo '<img     height="200" width="200" src="image1//'.$im.'">' ?>
             </td>
          ...
          <tr>
             <th>Age starting</th>
             <td>
                  <input type="text" id="t6" name="t6" value="<?php                    echo $rs['age_s']?>">
             </td>
          </tr>
          <tr>
             <th>ending age</th>
          ...
          <tr>
             <th>height</th>
             <td>
                 <input type="text" id="t8" name="t8" value="<?php                    echo $rs['m_height']?>">
             </td>
          </tr>
          <tr>
             <th>religion</th>
             <td>
                 <input type="text" id="t9" name="t9" value="<?php                   echo $rs['religion']?>">
             </td>
          </tr>
          <tr>
             <th>Police Station</th>
             <td>
                <input type="text" id="t10" name="t10" value="                          <?php echo $rs['p_station']?>">
             </td>
          </tr>
          <tr>
           <th>Status</th>
           <td><input type="text" id="t11" name="t11" value="<?php echo $rs['status']?>" /></td>
          </tr>
          </table>
          <tr><td>&nbsp;</td></tr>
          <center>
          ...
          <tr>
            <td>
               <input type="submit" id="t15" name="t15" value="update">
            </td>
         </tr>
         </table>
         </center>
