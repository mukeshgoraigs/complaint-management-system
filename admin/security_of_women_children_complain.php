...
<div style="min-height:314px;" class="text-cont">
 ...
 <fieldset class="tabul1"> 
  <legend style="font-weight:bolder; font-size:18px; color:#33F;">Complain Form</legend>
  <table align="center">
  <form id="f1" name="f1" method="post" action="security_of_women_children_complain_conn.php">
     <tr>
        <td>Name:</td>
        <td><input type="text" id="t1" name="t1" size="65px;"/></td>
     </tr>
     <tr>
        <td>Address:</td>
        <td><textarea rows="3" cols="50" name="t2" style="resize:none;"></textarea></td>
     </tr>
     <tr>
        <td>Contact No.:</td>
        <td><input type="number" id="t3" name="t3"/></td>
     </tr>
     <tr>
        <td>Complain:</td>
        <td><textarea rows="10" cols="50"  name="t4" style="resize:none;"></textarea></td>
     </tr>
 </table>
 <table align="center">
     <tr>
        <td class="tabul"><input type="submit" value="submit" style="font-weight:bolder;" /></td>
        <td>&nbsp;&nbsp;</td>
        <td class="tabul"><input type="reset" value="reset" style="font-weight:bolder;" /></td>
     </tr>
 </table>
 </form>
 </fieldset>
