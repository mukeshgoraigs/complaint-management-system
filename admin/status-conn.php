...
<div class="button-main">
  <div class="btn">
      <ul>
        ...
        <li><a href="#" data-flexmenu="flexmenu3" stylez="position:relative;left:900px;top:200px" class="">GET YOUR STATUS</a>
        </li>
...
<?php
	   $conn=mysqli_connect("localhost","root","");
		 ...
		 $n=$_POST['t1'];
		    if($op==1)
			{
				$qry="select * from firregister where area_id='$n'";
			}
			else
			{
				$qry="select * from firregister where fir_id='$n'";
			}
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td>
       <form id="f1" name="f1" method="post" action="status-conn1.php">
    <table>
          <tr>
             <th>FIR_id</th>
             <td>
                <input type="text" id="t1" name="t1" value="<?php echo                 $rs['fir_id']  ?> ">
             </td>
          </tr>
          <tr>  
             <th>Name</th>
             <td>
                <input type="text" id="t2" name="t2" value="<?php echo                    $rs['name']?>">
             </td>
          </tr>
          <tr>
             <th>Phone no.</th>
             <td>
                <input type="text" id="t3" name="t3" value="<?php echo                   $rs['phone'] ?>">
             </td>
          </tr>
          <tr>
             <th>E_mail</th>
             <td>
                <input type="text" id="t4" name="t4" value="<?php                   echo $rs['email'] ?>">
             </td>
          </tr>
          <tr>
             <th>Address</th>
             <td>
                 <input type="text" id="t5" name="t5" value="<?php                    echo $rs['address'] ?>">
             </td>
          </tr>
          <tr>
             <th>Area_id</th>
             <td>
                  <input type="text" id="t6" name="t6" value="<?php                    echo $rs['area_id']?>">
             </td>
          </tr>
          <tr>
             <th>Time & Date</th>
             <td>
                 <input type="text" id="t7" name="t7" value="<?php echo
			      $rs['time_date']?>">
             </td>
          </tr>
          <tr>
             <th>Crime_Title</th>
             <td>
                 <input type="text" id="t8" name="t8" value="<?php                    echo $rs['Crime_Title']?>">
             </td>
          </tr>
          <tr>
             <th>FIR_description</th>
             <td>
                 <input type="text" id="t9" name="t9" value="<?php                   echo $rs['fir_description']?>">
             </td>
          </tr>
          <tr>
             <th>FIR_remark</th>
             <td>
                <input type="text" id="t10" name="t10" value="                          <?php echo $rs['fir_remark']?>">
             </td>
          </tr>
          <tr>
             <th>Gender</th>
             <td>
                 <input type="text" id="t11" name="t11" value="<?php                       echo $rs['gender'] ?>">
             </td>
         </tr>
         <tr>
         ...
         <tr>
            <td>
               <input type="submit" id="t15" name="t15" value="Insert">
            </td>
         </tr>
         </table>
         </form>
