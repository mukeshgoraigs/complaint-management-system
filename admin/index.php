...
<ul id="flexmenu3" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1003; left: 534px; top: 152px; display: none;">
        ...
        <li><a href="vfedback.php">view feedback</a></li>
        </ul>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td><img src="image/admin1.png" width="110" height="100" style="margin-left:-20px;"/>
            <p style="font-size:30px; color:#F00; font-weight:bolder; margin-left:130px; margin-top:-60px; text-shadow:#C33 2px 2px">Welcome to Admin</p>
            
            
            
            <iframe src="image/clock3.html"  style="width:480px; height:80px; margin-top:40px;  border-bottom-left-radius:10px; border-bottom-right-radius:10px; border-top-left-radius:10px; border-top-right-radius:10px;"></iframe></td>
          </tr>
          <tr>
            <td height="25">&nbsp;</td>
          </tr>
