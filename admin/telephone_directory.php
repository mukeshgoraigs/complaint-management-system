      ...
      <div class="left-side-page-index">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left; clear:both;">
         ...
         <table>
            ...
            <tr>
              <td><img src="image/hotline_no.jpg" style="border:solid;" width="240" height="182"/></td>
            </tr>
          </table>
...
<!-----------------start mid form------------------------------------->
          ...
          <table width="100%" border="0" cellspacing="2" cellpadding="2">
            <tbody><tr>
              <td align="center"><h2 class="help-line-head">Telephone Directory</h2></td>
            </tr>
            <tr>
       ...
       <select name="users" onchange="showUser(this.value)">
         ...
         <option value="kanke">kanke</option>
            ...
            <tr>
              <td colspan="2">
       <div id="txtHint">       
   <table width="100%" border="1" cellspacing="0" rules="all" class="td-space">
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td>PCR</td>
                    <td><b>100 (24X7) (Toll Free)</b></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td> Eyes and Ears </td>
                    <td><b>1090 (Toll Free) </b></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><b>1094, 23241210</b></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td> Traffic </td>
                    <td><b>1095, 25844444</b></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td> Vigilance </td>
