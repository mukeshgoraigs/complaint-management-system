...
<?php
    ...
    <table border="2">
         ...
         <?php
		   while(($rs=mysqli_fetch_row($smt)))
		   {
			   echo"<tr>";
			   echo"<td>".$rs['fir_id']."</td>";
			   echo"<td>".$rs['name']."</td>";
			   echo"<td>".$rs['phone']."</td>";
			   echo"<td>".$rs['email']."</td>";
			   echo"<td>".$rs['address']."</td>";
			   echo"<td>".$rs['area_id']."</td>";
			   echo"<td>".$rs['time_date']."</td>";
			   echo"<td>".$rs['Crime_Title']."</td>";
			   echo"<td>".$rs['fir_description']."</td>";
			   echo"<td>".$rs['fir_remark']."</td>";
