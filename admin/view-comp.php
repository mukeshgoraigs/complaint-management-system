...
<div class="button-main">
  <div class="btn">
      <ul>
        ...
        <li><a href="#" data-flexmenu="flexmenu3" stylez="position:relative;left:900px;top:200px" class="">VIEW FIR</a>
        </li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <form id="f1" name="formkey" method="POST" action="view-comp-action.php">
      <table cellpadding="4" cellspacing="10">
        <tr>
           <td>View  F.I.R by</td><td><select name="s" id="s1">
                        <option value="0">select</option>
                        <option value="1">Date</option>
                        <option value="2">fir_id</option>
                        </select>
                       </td>
        </tr>
        <tr>
           <td>enter key</td>
           <td><input type="text" name="t" id="t1"></td>
        </tr>
        <tr>
           <td colspan="2">
            <input type="submit" id="s11" name="formkey">
           </td>
        </tr>
      </table>
    </form>
