...
<div style="min-height:314px;" class="text-cont">
 ...
 <legend style="font-weight:bolder; font-size:18px; color:#33F;">Missing Person
 </legend>
 <form id="f1" name="f1" method="post" action="missing-person-action.php">
 <table align="center">
     <tr>
       <td>Missing Date:</td>
       <td><input type="date" id="t" name="t" /></td>
     </tr>
     <tr>
      <td>Name :</td>
     ...
     <tr>
      <td>Photo :</td>
      <td><input type="file" name="t2" id="t2" /></td>
     </tr>
     <tr>
      <td>Age range from:</td>
      <td><input type="text" name="t3" id="t3" /></td>
      <td>End:</td>
      <td><input type="text" name="t4" id="t4" /></td>
     </tr>
     <tr>
       <td>Height(feet & Inches)/cms:</td>
