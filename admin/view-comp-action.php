...
<?php
	   $conn=mysqli_connect("localhost","root","");
		...
		$n=$_POST["t"];
		    ...
		    if($op==1)
			{
				$qry="select * from complain where date='$n'";
			}
			else
			{
				$qry="select * from complain where fir_id='$n'";
			}
    ...
    <table border="2">
         ...
         <?php
		   ...
		   while($result=mysqli_fetch_assoc($smt))
			  
		   {
			   echo"<tr>";
			   echo"<td>".$result['fir_id']."</td>";
			   echo"<td>".$result['name']."</td>";
			   echo"<td>".$result['address']."</td>";
			   echo"<td>".$result['phn_number']."</td>";
			   echo"<td>".$result['complain']."</td>";
