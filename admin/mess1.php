...
<div class="right-index-main">
 ...
 <tr>
              <td align="center"><h3>TARIFF PER DAY</h3></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><ul>
                <li>All booking for the accommodation in the Transit Mess will be done by DCP/HQ through<br>
                  QAC Cell/PHQ.</li>
                <li> However, booking of two single rooms will also be available with DCP/Central District in<br>
                  emergent cases.</li>
                <li>Accommodation shall not be provided for a period exceeding 15 days unless the same is<br>
                  occupied by a serving AGMUT Cadre/Delhi Police Officer or by an officer of a Central/State<br>
                  Para Military Force on duty with the Delhi Police.</li>
              </ul></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td align="center"><h3>Water, Electric, Service, Linen &amp; other charges</h3></td>
            </tr>
            </tbody>
            </table>
            </div>
