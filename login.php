    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td><em><img src="image/lost-report-img copy.jpg" alt="" width="407" height="110" border="0" usemap="#Map"></em></td>
          </tr>
          <tr>
            <td height="25">&nbsp;</td>
          </tr>
...
<map name="Map" id="Map">
   <button id="b1"><area shape="rect" coords="19,61,153,96" href="#"></button>
 
 <button  id="b2"><area shape="rect" coords="250,61,388,96" href="#" alt=""></button>
  
  <div id="user" class="background">
         <div id="user" class="transbox">
          <img src="image/layout_middle_right.gif" width="480" height="40">
          <img src="image/layout_icon.gif" class="key">
          <b class="lgn1">User Login</b>
        <form method="post" id="f1" action="login_action.php">
            <table class="frm">
              <tr>
                 <td style="font-size:14px; font-weight:bold; width:100px;">User Name:</td>
                 <td><input type="text" id="t1" name="t1" placeholder="Enter Valid User Name"><b style="color:#F00;">*</b>
                 </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                 <td style="font-size:14px; font-weight:bold;">Password:</td>
                 <td><input type="password" id="t2" name="t1" placeholder="Enter Valid Password"><b style="color:#F00;">*</b>
                 </td>
              </tr>
            </table>
            <table class="frm1">
              <tr>
                <td>
                 <input type="submit" style="font-weight:bolder;" value="SUBMIT" onclick="lgn();">
         ...
         <div id="admin" class="background">
         <div id="admin" class="transbox">
          <img src="image/layout_middle_right.gif" width="480" height="40">
          <img src="image/layout_icon.gif" class="key">
          <b class="lgn1">Admin Login</b>
        <form method="post" id="f1" action="admin">
            <table class="frm">
              <tr>
                 <td style="font-size:14px; font-weight:bold; width:100px;">User Name:</td>
                 <td><input type="text" id="txt_admin" name="txt_admin" placeholder="Enter Valid admin id"><b style="color:#F00;">*</b>
                <!-- <span class="error">**<?php echo $err;?></span></td>-->
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                 <td style="font-size:14px; font-weight:bold;">Password:</td>
                 <td><input type="password" id="txt_pswd1" name="txt_pswd1" placeholder="Enter Valid Password"><b style="color:#F00;">*</b>
            ...
            <table class="frm1">
              <tr>
                <td>
                 <input type="submit" style="font-weight:bolder;" value="SUBMIT" onclick="lgn();">
                 <input type="submit" style="font-weight:bolder;" value="RESET" onclick="reset();">
                </td>
              </tr>
              <tr>
              <td><a href="admin-registration.php"><input type="button" name="b1" value="new user" /></a></td>
              </tr>
            </table>
