...
function showUser(str) {
  ...
  xmlhttp.open("GET","tinsert-action.php?q="+str,true);
  xmlhttp.send();
}
</script>
</head>
...
<ul id="flexmenu3" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1003; left: 534px; top: 152px; display: none;">
        ...
        <li><a href="#">Mounted Police</a></li>
        <li style="z-index: 1000;"><a href="#">EOW<img src="image/arrow.gif" class="rightarrowclass" style="border:0;"></a>
        <ul style="display: none; visibility: visible;">
        <li><a href="#" target="_blank">Mission Statement</a></li>
        <li><a href="#">Proclaimed Economic Offenders</a></li>
        <li><a href="#">Wanted-Land/Property Offenders</a></li>
        <li><a href="#">Proclaimed Offenders-Land / Property</a></li>
        <li><a href="#">Wanted Economic Offenders</a></li>
        </ul>
        </li>
        </ul>
<ul id="flexmenu5" class="flexdropdownmenu jqflexmenu" style="visibility: visible; z-index: 1001; left: 788px; top: 152px; display: none;">
        ...
        <li><a href="#">Yuva Trained Individual List</a></li>
        <li><a href="#">CAW Instructions</a></li>
        <li><a href="#" target="_blank">CGHS Empanelled Hospital</a></li>
        <li><a href="#">Recruitments</a></li>
        <li><a href="#">Help Lines</a></li>
        <li><a href="#" target="_blank">Zonal Integrated Police Network</a></li>
...
<option value="1">kotwali</option>
<option value="2">sadar</option>
<option value="3">sukhdeo nagar</option>
<option value="4">gonda</option>
<option value="5">hindipiri</option>
<option value="6">kanke</option>
<option value="7">bariatu</option>
<option value="8">doranda</option>
<option value="9">dhurwa</option>
<option value="10">jagannathpur</option>
<option value="11">argora</option>
</select>
</form>
<br>
<div id="txtHint"><b>your information</b></div>
        ...
        <td width="33%" align="right" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td><a href="#"><img src="image/media-press.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          ...
          <tr>
            <td><a href="#"><img src="image/rejoinders.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          <tr>
            <td><a href="#" target="_blank"><img src="image/view-fir.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          <tr>
            <td><a href="3"><img src="image/department-contacts.jpg" width="242" height="29" alt=""></a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
          <tr>
            <td><a href="#" target="_blank"><img src="image/tenders.jpg" width="242" height="29" alt=""></a></td>
          </tr>
        </tbody></table></td>
        </tr>
    </tbody></table></td>
