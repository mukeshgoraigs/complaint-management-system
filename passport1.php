            ...
            <tbody><tr>
              <td><p class="mission_heading">SPECIAL BRANCH – Verification related to Passport and character &amp; antecedents. </p><br>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody><tr>
                  <td>
                   <p><strong>2.&nbsp;&nbsp; Stay/Residence  Proof/Nationality:- </strong></p>
                      <p>One of the  following documents is required:-</p>
                      <ul>
                        <li>Telephone/Electricity/Water Bills.</li>
                        <li>Statement of Running PSU Bank Accounts.</li>
                        <li>&nbsp;Income  Tax Assessment Order.</li>
                        <li>Spouse’s Passport Copy, Parent’s Passport Copy  in case of minors.</li>
                        <li><strong>&nbsp;</strong>Electors  Photo Identity Card (EPIC).</li>
                        <li>&nbsp;Service  Identity Cards issued by State/Central Government, Public Sector Undertakings,  Local bodies or Public Limited Companies</li>
                        <li>SC/ST/OBC Certificates</li>
                        <li>Freedom Fighter Identity Cards</li>
                        <li>&nbsp;Arms  Licenses</li>
                        <li>Property Documents such as Pattas, Registered  Deeds etc.</li>
                        <li>Pension Documents such as Ex-Servicemen’s  Pension book/Pension Payment Order, Ex-Servicemen’s Widow/Dependent  Certificates, Old Age Pension Order, and Widow Pension Order.</li>
                        <li>Income Tax Identity (PAN) cards.</li>
                        <li>Bank/Kisan/Post Office Passbooks </li>
                        <li>Student Identity Cards issued by recognized  educational institutions.</li>
                        <li>Marriage certificate or combined affidavit  (husband/wife) duly attested by Notary as per prescribed format (in case of  change of surname of female passport applicant after marriage).</li>
                      </ul>
                     
                  </td>
                </tr>
 <tr><td><a href="passport.php"><center><input type="button" value=">>back<<"></center></a></td></tr>
</tbody>
</table>
</td>
</tr>
