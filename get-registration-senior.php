...
<div class="news-flash-heading"><img src="image/help-line-head.png" width="95" height="32" alt=""></div>
 ...
 <?php
	   $conn=@mysql_connect("localhost","root","");
		 ...
		 $qry="select * from senior_citizen order by regd_id desc limit 1";
		 $smt=mysql_query("$qry");
		 $rs=mysql_fetch_assoc($smt);
	?>
   <center><font color="#FF3366"> <b>congratulation!!!</b></font><br><br>
    <i><font size="+2">your registration has successfully done</font></i><br>
    </center>
    <form>
      <center><table>
         <tr><br><td ><font color="#FF0033"><b>your registration id is:</b></font></td>
                 <td><font color="#FF0000"><b><?php echo"".$rs["regd_id"]."";?></b></font>
                 </td>
         </tr>
      </table></center>
    </form>
