...
<div style="min-height:314px; background:url(image/traffic/traffic1.png)" class="text-cont">
  ...
  <img src="image/help-line-head1.png" width="120" height="32" alt="" style="margin-top:120px;">
        ...
        <img src="image/healp-line-bullet.png" width="11" height="13" alt=""><a href="traffic-chalan.php" style="background:none; color:#000;">&nbsp;Online e-challan registration</a> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/healp-line-bullet.png" width="11" height="13" alt="">&nbsp;<a href="challan-status.php" style="background:none; color:#000;">e-challan status</span>
        </marquee>
        </div> 
