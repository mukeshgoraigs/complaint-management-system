...
<?php
	   $conn=@mysql_connect("localhost","root","");
		 ...
		 $n=$_REQUEST['t1'];
		    if($op==1)
			{
				$qry="select * from traffic where date='$n'";
			}
			else
			{
				$qry="select * from traffic where challan_no='$n'";
			}
			$smt=mysql_query($qry);
	?>
    <table border="2">
         ...
         <?php
		   ...
		   {
			   echo"<tr>";
			   echo"<td>".$rs['challan_no']."</td>";
			   echo"<td>".$rs['name']."</td>";
			   echo"<td>".$rs['gender']."</td>";
			   echo"<td>".$rs['age']."</td>";
			   echo"<td>".$rs['vehicle_no']."</td>";
			   echo"<td>".$rs['licence_no']."</td>";
			   echo"<td>".$rs['comp_issue']."</td>";
			   echo"<td>".$rs['date']."</td>";
			   echo"<tr>";
		   }
		 ?>  
